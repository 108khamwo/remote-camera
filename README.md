# Remote Camera PWA v0.9.5 — Zoom speed accumulator fix
...
# Remote Camera PWA v0.9.5 — Remote Control Reliability
...
# Remote Camera PWA v0.9.5 — Auto Discovery


## แก้ปัญหา Discovery ซ้ำ/Online กระพริบใน v0.9.5
