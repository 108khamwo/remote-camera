const CACHE='remote-camera-v04';
const ASSETS=['./','./index.html','./sender.html','./control.html','./receiver.html','./styles.css?v=04','./sdk-loader.js?v=04','./sender.js?v=04','./control.js?v=04','./manifest.webmanifest'];
