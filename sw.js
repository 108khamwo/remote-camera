const CACHE='remote-camera-v050';
const ASSETS=['./','./index.html','./sender.html','./control.html','./receiver.html','./styles.css?v=050','./sdk-loader.js?v=050','./sender.js?v=050','./control.js?v=050','./manifest.webmanifest'];
