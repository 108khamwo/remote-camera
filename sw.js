const CACHE='remote-camera-v041';
const ASSETS=['./','./index.html','./sender.html','./control.html','./receiver.html','./styles.css?v=041','./sdk-loader.js?v=041','./sender.js?v=041','./control.js?v=041','./manifest.webmanifest'];
