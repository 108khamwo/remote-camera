const CACHE='remote-camera-v091';
const ASSETS=['./','./index.html','./sender.html','./control.html','./receiver.html','./styles.css?v=091','./sdk-loader.js?v=091','./sender.js?v=091','./control.js?v=091','./manifest.webmanifest'];
