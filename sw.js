const CACHE='remote-camera-v095';
const ASSETS=['./','./index.html','./sender.html','./control.html','./receiver.html','./styles.css?v=095','./sdk-loader.js?v=095','./sender.js?v=095','./control.js?v=095','./manifest.webmanifest'];
