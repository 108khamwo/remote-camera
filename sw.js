const CACHE='remote-camera-v099';
const ASSETS=['./','./index.html','./sender.html','./control.html','./receiver.html','./styles.css?v=099','./sdk-loader.js?v=099','./sender.js?v=099','./control.js?v=099','./manifest.webmanifest'];
