const CACHE='remote-camera-v0115';
const ASSETS=['./','./index.html','./sender.html','./control.html','./receiver.html','./styles.css?v=0115','./sdk-loader.js?v=0115','./sender.js?v=0115','./control.js?v=0115','./manifest.webmanifest'];
