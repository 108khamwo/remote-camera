const CACHE='remote-camera-v098';
const ASSETS=['./','./index.html','./sender.html','./control.html','./receiver.html','./styles.css?v=098','./sdk-loader.js?v=098','./sender.js?v=098','./control.js?v=098','./manifest.webmanifest'];
