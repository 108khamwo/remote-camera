const CACHE='remote-camera-v0110';
const ASSETS=['./','./index.html','./sender.html','./control.html','./receiver.html','./styles.css?v=0110','./sdk-loader.js?v=0110','./sender.js?v=0110','./control.js?v=0110','./manifest.webmanifest'];
