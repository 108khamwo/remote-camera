const CACHE='remote-camera-v0112';
const ASSETS=['./','./index.html','./sender.html','./control.html','./receiver.html','./styles.css?v=0112','./sdk-loader.js?v=0112','./sender.js?v=0112','./control.js?v=0112','./manifest.webmanifest'];
