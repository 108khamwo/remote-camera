const CACHE='remote-camera-v090';
const ASSETS=['./','./index.html','./sender.html','./control.html','./receiver.html','./styles.css?v=090','./sdk-loader.js?v=090','./sender.js?v=090','./control.js?v=090','./manifest.webmanifest'];
