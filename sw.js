const CACHE='remote-camera-v092';
const ASSETS=['./','./index.html','./sender.html','./control.html','./receiver.html','./styles.css?v=092','./sdk-loader.js?v=092','./sender.js?v=092','./control.js?v=092','./manifest.webmanifest'];
