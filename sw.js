const CACHE='remote-camera-v0113';
const ASSETS=['./','./index.html','./sender.html','./control.html','./receiver.html','./styles.css?v=0113','./sdk-loader.js?v=0113','./sender.js?v=0113','./control.js?v=0113','./manifest.webmanifest'];
