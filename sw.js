const CACHE='remote-camera-v0100';
const ASSETS=['./','./index.html','./sender.html','./control.html','./receiver.html','./styles.css?v=0100','./sdk-loader.js?v=0100','./sender.js?v=0100','./control.js?v=0100','./manifest.webmanifest'];
