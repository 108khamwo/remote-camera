const CACHE='remote-camera-v094';
const ASSETS=['./','./index.html','./sender.html','./control.html','./receiver.html','./styles.css?v=094','./sdk-loader.js?v=094','./sender.js?v=094','./control.js?v=094','./manifest.webmanifest'];
