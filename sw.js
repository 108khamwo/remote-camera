const CACHE='remote-camera-v060';
const ASSETS=['./','./index.html','./sender.html','./control.html','./receiver.html','./styles.css?v=060','./sdk-loader.js?v=060','./sender.js?v=060','./control.js?v=060','./manifest.webmanifest'];
