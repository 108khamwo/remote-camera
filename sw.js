const CACHE='remote-camera-v070';
const ASSETS=['./','./index.html','./sender.html','./control.html','./receiver.html','./styles.css?v=070','./sdk-loader.js?v=070','./sender.js?v=070','./control.js?v=070','./manifest.webmanifest'];
