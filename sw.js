const CACHE='remote-camera-v0101';
const ASSETS=['./','./index.html','./sender.html','./control.html','./receiver.html','./styles.css?v=0101','./sdk-loader.js?v=0101','./sender.js?v=0101','./control.js?v=0101','./manifest.webmanifest'];
